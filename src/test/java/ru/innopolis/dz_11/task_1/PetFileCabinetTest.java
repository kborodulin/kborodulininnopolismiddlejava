...
public class PetFileCabinetTest {
    ...
    public void addAnimalTest() throws Exception {
        ...
        for (Animal animal : animalList) petFileCabinet.addAnimal(animal);
    ...
    public void findAnimalByName() throws Exception {
        ...
        assertEquals(animal1.getPerson(), animal2.getPerson());
        ...
        assertEquals(animal10.getPerson(), animal20.getPerson());
    }
    ...
    public void renameAnimal() throws Exception {
        ...
        assertEquals(animal.getWeight(), animal1.getWeight());
    }
